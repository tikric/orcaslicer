...
function devServerBridgePlugin() {
	...
	const injectBundledDevCarrier = () => {
		if (!isBundledDev) return void 0;
		return [{
			tag: "script",
			attrs: { type: "module" },
	...
	return {
		...
		transform(code, id, options) {
			...
			if (!isPreviewExecuteClientCarrier(id)) return null;
			return {
		...
		transformIndexHtml: {
			order: "pre",
			handler: injectBundledDevCarrier,
			enforce: "pre",
			transform: injectBundledDevCarrier
		}
	};
}
//#endregion
export { devServerBridgePlugin };
